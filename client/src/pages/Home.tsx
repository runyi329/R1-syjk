            ...
            {authData ? (
              <div className="flex gap-2 items-center">
                ...
                {userData && (
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button className="flex flex-col sm:flex-row sm:items-center gap-0.5 sm:gap-2 hover:opacity-80 transition-opacity cursor-pointer text-right sm:text-left">
