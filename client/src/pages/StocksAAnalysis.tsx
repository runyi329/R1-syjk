      ...
      <main className="flex-1 container mx-auto px-4 py-8 space-y-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-bold">A股分析</h1>
              <p className="text-muted-foreground mt-2">流动性最强的中国股票市场，提供实时数据分析和投资建议</p>
            </div>
          </div>
        </section>
              ...
              <div className="h-[300px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={priceHistory}>
                    <defs>
                      <linearGradient id="colorPriceA" x1="0" y1="0" x2="0" y2="1">
        ...
        {/* 模拟投注 */}
        <StockSimulation marketType="A" marketName="A股" />
          ...
          <Card className="border-l-4 border-l-primary">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                A股市场近期呈现震荡上升态势。上证指数在3200-3300区间反复争夺，成交量温和放大。技术面上，日线形成双底形态，有望突破前期高点。创业板表现强势，新能源、半导体等板块领涨。建议投资者关注政策面变化，逢低布局优质成长股。
              </p>
            ...
            <Card className="border-l-4 border-l-green-500">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  A股市场流动性充足，适合中长期投资。建议采用定投策略，分批布局优质蓝筹股和成长股。关注政策支持力度，把握结构性机会。风险承受能力较强的投资者可适当配置创业板和科技股。
                </p>
              </CardContent>
            </Card>
          </div>
